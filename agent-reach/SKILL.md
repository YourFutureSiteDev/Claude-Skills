...
name: agent-reach
description: >
  Read and search content on social and video platforms that ordinary web
  search and Firecrawl cannot reach: Twitter/X, Reddit, Instagram, LinkedIn,
  Facebook, YouTube, Bilibili, XiaoHongShu, V2EX, GitHub code search, RSS.
  Use when the user gives a link to one of those platforms, or asks what
  people are saying about something ON a named platform, or asks to pull a
  profile, a thread, a comment section, or video subtitles. Prefer WebSearch
  and Firecrawl for ordinary web research and for reading normal websites;
  reach for this only when the target is one of the platforms above.
